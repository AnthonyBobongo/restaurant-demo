...
const menuItems = [
  {
    name: "Soeul-Style Spareribs",
    price: 22.0,
    description:
      "Hand-rubbed with Bobs’s secret blend of spices and pit-smoked for 3-4 hours over a smoldering hickory fire",
  },
  {
...
class MenuPage extends Component {
  render() {
    return (
      <div>
        <SEO
          title="Jokbal Korean BBQ Menu"
          description="Jokbal Korean BBQ Menu"
        />
        <Header />
