...
const roles = [
  {
    name: "BARTENDER",
    description:
      "You and your team ensure patrons have a spectacularexperience and keep the bar stocked with top-notch beverages.",
  },
  {
    name: "HOST / CASHIER",
    description:
      "You will greet patrons like family, get them seated comfortably, and do everything you can to make sure they leave with a smile.",
  },
  {
    name: "SERVER",
    description:
      "You'll work with a dynamic team to impress every patron with our Jokbal Korean BBQ values and spectacular customer service.",
  },
]
        ...
        <div className="join-us-cointainer">
          ...
          <div className="join-us-content">
            <h3 className="join-us-description">
              Wanna join the Jokbal Korean BBQ team?
            </h3>
          </div>
              ...
              return (
                <div className="roles-div">
                  ...
                  <p className="roles-descroption">
                    Contact info@jokbal.com for more info
                  </p>
